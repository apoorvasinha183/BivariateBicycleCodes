...
#options = {'defectType':'singledefect','codeName':codeName,'nTrials':1000,'fileName':fileName,'progressTrack':True,'ncyc':nyc}
options = {'defectType':'doubleDefect','codeName':codeName,'nTrials':1000,'fileName':fileName,'progressTrack':True,'ncyc':nyc}
